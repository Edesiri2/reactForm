...
function App() {
  return (
    <Routes>
      ...
      <Route
        path="/termassurancebenefit"
        Component={Pages.TermAssuranceBenefit}
      />
      <Route path="/wholelife" Component={Pages.WholeLifeAssurance} />
      <Route
        path="/wholelifebenefit"
        Component={Pages.WholeLifeAssuranceBenefit}
      />
      <Route path="/ordinaryendowment" Component={Pages.OrdinaryEndowment} />
      <Route
        path="/ordinaryendowmentbenefit"
        Component={Pages.OrdinaryEndowmentBenefit}
      />
      ...
      <Route
        path="/investmentplusplanbenefit"
        Component={Pages.InvestmentPlusPlanBenefit}
      />
      <Route path="/educationendowment" Component={Pages.EducationEndowment} />
      <Route
        path="/educationendowmentbenefit"
        Component={Pages.EducationEndowmentBenefit}
      />
      ...
      <Route
        path="/capitalbenefit"
        Component={Pages.CapitalBuilderBenefitForm}
      />
