...
interface DignityPlanFormProps {
  title: string;
}

const DignityPlanForm: FC<DignityPlanFormProps> = ({ title }) => {
  ...
  return (
    <div className="h-[fit] w-[full] px-6 py-12">
      <div className="flex flex-col w-[100%]  h-[fit] md:h-[500px]  mt-2 px-16 bg-white rounded-lg shadow-lg ">
        ...
        <div className=" p-2 py-2 px-2 md:flex md:gap-6 md:px-4">
          <FormInputSelector
            placeholder={"Identification Type"} defalt={"National ID"} firstOption={"Driver License"} secondOption={"International Passport"} disabled={false}          />
          <FormInput
            onClick={() => {}}
...
export default DignityPlanForm;
