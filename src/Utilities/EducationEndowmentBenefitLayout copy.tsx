...
interface EducationEndowmentBenefitLayoutProps{
    title : string
}

const EducationEndowmentBenefitLayout: FC<EducationEndowmentBenefitLayoutProps> = ({title}) => {
  return (
...
export default EducationEndowmentBenefitLayout;
