...
interface CapitalBuilderBenefilLayoutProps{
    title : string
}

const CapitalBuilderBenefilLayout: FC<CapitalBuilderBenefilLayoutProps> = ({title}) => {
  return (
    <div className="h-[fit] w-[full] px-6 py-12">
      <div className="flex flex-col w-[100%] h-[fit] md:h-[500px]  mt-2 px-16 bg-white rounded-lg shadow-lg ">
        ...
        <FormInput
            onClick={() => { } }
            placeholder={"Amount to Save (Premium)"}
            type={"number"}
            required
            onBlur={() => { } }
...
export default CapitalBuilderBenefilLayout;
