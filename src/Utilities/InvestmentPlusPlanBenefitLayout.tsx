...
interface InvestmentPlusPlanBenefitLayoutProps {
  title: string;
}

const InvestmentPlusPlanBenefitLayout: FC<
  InvestmentPlusPlanBenefitLayoutProps
> = ({ title }) => {
  return (
...
export default InvestmentPlusPlanBenefitLayout;
