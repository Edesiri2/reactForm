...
interface FormCardStepTwoProps {
    title : string
}

const FormCardStepTwo: FC<FormCardStepTwoProps> = ({title}) => {
  return (
      ...
      <div className="flex flex-col w-[100%] h-[fit] md:h-[500px]  mt-2 px-16 bg-white rounded-lg shadow-lg ">
        ...
        <div className=" p-2 py-2 px-2 md:flex md:gap-6 md:px-4">
          ...
          <FormInput
            ...
            required
            onChange={() => { } }
            onBlur={() => { } } name={""} label={""} pattern={""} errorMessage={""}          />
        </div>

        <div className="flex gap-[40rem]  place-content-center   mt-16 ">
          <Link to="/">
...
export default FormCardStepTwo;
