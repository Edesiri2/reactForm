...
interface TermAssuranceBenefitLayoutProps{
    title : string
}

const TermAssuranceBenefitLayout: FC<TermAssuranceBenefitLayoutProps> = ({title}) => {
  return (
...
export default TermAssuranceBenefitLayout;
