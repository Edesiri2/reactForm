...
interface WholeLifeAssuranceFormProps {
  title : string
}

const WholeLifeAssuranceForm: FC< WholeLifeAssuranceFormProps> = ({title}) => {
...
export default WholeLifeAssuranceForm;
