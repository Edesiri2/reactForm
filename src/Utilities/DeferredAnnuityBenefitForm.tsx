...
interface DeferredAnnuityBenefitFormProps {
    title : string
}

const DeferredAnnuityBenefitForm: FC<DeferredAnnuityBenefitFormProps> = ({title}) => {
  return (
...
export default DeferredAnnuityBenefitForm;
